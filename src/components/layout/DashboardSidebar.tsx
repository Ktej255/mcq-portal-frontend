...
const studentNavItems = [
  { name: 'Today', href: '/upsc', icon: CalendarCheck },
        ...
        <div className="flex-1 py-4 px-4 space-y-8 overflow-y-auto">
          <div className="space-y-1">
            ...
            <nav className="space-y-1">
              {navItems.map((item) => {
                // "Today" (/upsc) stays highlighted across all study sub-pages.
                // Every other destination matches its own route exactly (or nested children).
                const isActive =
                  item.href === '/upsc'
                    ? pathname === '/upsc' || pathname.startsWith('/upsc/')
